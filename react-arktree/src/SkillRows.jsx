...
function SkillRow() {
  ...
  <Container fluid className="SkillRows mb-1 ">
    <Row  className="SkillCard "> {/* flex-nowrap sm<576px xs >=576 */}
      <Col sm='auto' xs={{span:2, order: 1}} className="img-container my-auto">
        <Image className="skill-img border border-dark" height='48' width='48' src={require("./images/Artillerist/BS_Skill_01_0.png")}  ></Image>
      </Col>
      <Col sm='3' xs={{span:10, order: 2}}  className="SkillCard_skill_container my-auto ">
...
{/* d-none d-sm-block*/}
      <Col sm='auto' xs={{span:4, order: 3}} className="SkillCard_reqtype text-center my-auto ">
        <Stack gap='1'>
      ...
      <Col sm='auto' xs={{span:4, order: 4}}  className="SkillCard_lvltype_lvl text-center my-auto  ">
        <Stack gap='1'>
      ...
      <Col  xs={{span:2, order: 4}}  className="SkillCard_buttons_container my-auto ">
        <Stack >
      ...
      <Col sm='auto' xs={{span:2, order: 4}}  className="img-tripod-container my-auto  d-flex justify-content-center " >
