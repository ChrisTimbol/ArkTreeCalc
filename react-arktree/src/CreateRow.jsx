...
function CreateRow(characterRole, setSkillClicked) {
    ...
    if (characterRole === "Artillerist") {   
      ...
      return Object.keys(wardancerImages).map((image, index) => {
        ...
        return <SkillRow setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={wardancerImages[image]} skillType={skillTypeText} skillName={wardancerSkillNameText[index]} />
      })
    }
  }
