...
function CreateRow(characterRole, setSkillClicked) {
    ...
    if (characterRole === "Artillerist") {   
      ...
      return Object.keys(artilleristImages).map((image, index) => {
        ...
        return <SkillRow  characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]} skillImage={artilleristImages[image]} skillType={skillTypeText} skillName={artilleristSkillNameText[index]} />
      })
      ...
      return Object.keys(bardImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={bardImages[image]} skillType={skillTypeText} skillName={bardSkillNameText[index]} />
      })
      ...
      return Object.keys(berserkerImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={berserkerImages[image]} skillType={skillTypeText} skillName={berserkerSkillNameText[index]} />
      })
      ...
      return Object.keys(deadeyeImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={deadeyeImages[image]} skillType={skillTypeText} skillName={deadeyeSkillNameText[index]} />
      })
      ...
      return Object.keys(deathbladeImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={deathbladeImages[image]} skillType={skillTypeText} skillName={deathbladeSkillNameText[index]} />
      })
      ...
      return Object.keys(gunlancerImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]} skillImage={gunlancerImages[image]} skillType={skillTypeText} skillName={gunlancerSkillNameText[index]} />
      })
      ...
      return Object.keys(gunslingerImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={gunslingerImages[image]} skillType={skillTypeText} skillName={gunslingerSkillNameText[index]} />
      })
      ...
      return Object.keys(paladinImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={paladinImages[image]} skillType={skillTypeText} skillName={paladinSkillNameText[index]} />
      })
      ...
      return Object.keys(scrapperImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={scrapperImages[image]} skillType={skillTypeText} skillName={scrapperSkillNameText[index]} />
      })
      ...
      return Object.keys(shadowhunterImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={shadowhunterImages[image]} skillType={skillTypeText} skillName={shadowhunterSkillNameText[index]} />
      })
      ...
      return Object.keys(sharpshooterImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={sharpshooterImages[image]} skillType={skillTypeText} skillName={sharpshooterSkillNameText[index]} />
      })
      ...
      return Object.keys(sorceressImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]} skillImage={sorceressImages[image]} skillType={skillTypeText} skillName={sorceressSkillNameText[index]} />
      })
      ...
      return Object.keys(soulfistImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={soulfistImages[image]} skillType={skillTypeText} skillName={soulfistSkillNameText[index]} />
      })
      ...
      return Object.keys(strikerImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={strikerImages[image]} skillType={skillTypeText} skillName={strikerSkillNameText[index]} />
      })
      ...
      return Object.keys(wardancerImages).map((image, index) => {
        ...
        return <SkillRow characterRole={characterRole} setSkillClicked={setSkillClicked} key={Element+[index]}  skillImage={wardancerImages[image]} skillType={skillTypeText} skillName={wardancerSkillNameText[index]} />
      })
    }
  }
