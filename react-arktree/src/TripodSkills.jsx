        ...
        <Col className="Triport_Container_Inside border border-dark sticky-top">
            ...
            <Row className="Triport_tier1_row ">
                <Col className="Triport_Image_Col d-flex justify-content-center">
                    <figure>
                        <Image src={createTripod(props.skillClicked)[0][0]} className="Tripod-img-1 " width='48' height='48'></Image>
                        <figcaption className="figure-caption ">{createTripod(props.skillClicked)[1][0]}</figcaption>
                    </figure>
                </Col>
                <Col className="Triport_Image_Col d-flex justify-content-center">
                    <figure>
                        <Image src={ createTripod(props.skillClicked)[0][1]} className="Tripod-img-2 " width='48' height='48'></Image>
                        <figcaption className="figure-caption">{createTripod(props.skillClicked)[1][1]}</figcaption>
                    </figure>
                </Col>
                <Col className="Triport_Image_Col d-flex justify-content-center">
                    <figure>
                        <Image src={createTripod(props.skillClicked)[0][2]} className="Tripod-img-3 " width='48' height='48'></Image>
                        <figcaption className="figure-caption">{createTripod(props.skillClicked)[1][2]}</figcaption>
                    </figure>
                </Col>
            </Row>
            <Row >
            ...
            <Row className="Triport_tier2_row ">
                <Col className="Triport_Image_Col d-flex justify-content-center">
                    <figure>
                        <Image src={createTripod(props.skillClicked)[0][3]} className="Tripod-img-4 " width='48' height='48'></Image>
                        <figcaption className="figure-caption">{createTripod(props.skillClicked)[1][3]}</figcaption>
                    </figure>
                </Col>
                <Col className="Triport_Image_Col d-flex justify-content-center">
                    <figure>
                        <Image src={createTripod(props.skillClicked)[0][4]} className="Tripod-img-5 " width='48' height='48'></Image>
                        <figcaption className="figure-caption">{createTripod(props.skillClicked)[1][4]}</figcaption>
                    </figure>
                </Col>
                <Col className="Triport_Image_Col d-flex justify-content-center">
                    <figure>
                        <Image src={createTripod(props.skillClicked)[0][5]} className="Tripod-img-6 " width='48' height='48'></Image>
                        <figcaption className="figure-caption">{createTripod(props.skillClicked)[1][5]}</figcaption>
                    </figure>
                </Col>
            </Row>
            <Row >
            ...
            <Row className="Triport_tier3_row   ">
                <Col className="Triport_Image_Col   d-flex justify-content-center">
                    <figure>
                        <Image src={createTripod(props.skillClicked)[0][6]} className="Tripod-img-7 " width='48' height='48'></Image>
                ...
                <Col className="Triport_Image_Col  d-flex justify-content-center">
                    <figure>
                        <Image fluid='true' src={createTripod(props.skillClicked)[0][7]} className="Tripod-img-8 " width='48' height='48'></Image>
